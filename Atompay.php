...
class Atompay {
    ...
    // private $customerMassId;
    private $customerComments;
    private $customerAddress;
    // private $customerDateTime;
    ...
    // public function getCustomerDateTime() {
    ...
    //  * @param string $customerName
    //  */
    // public function setCustomerDateTime($customerDateTime) {
    ...
    //     public function getCustomerMassId() {
    //                 return $this->customerMassId;
    //     }

    //         /**
    //          * @param string $customerName
    //          */
    //         public function setCustomerMassId($customerMassId) {
    //             $this->customerMassId = $customerMassId;
    //         }
    /**
    ...
    private function getData() {
        ...
        $strReqst .= "&udf4=" . $this->getCustomerComments();
         $strReqst .= "&udf5=" .$this->getCustomerAddress();
         // $strReqst .= "&udf11=" . $this->getCustomerDateTime();
         //  $strReqst .= "&udf12=" . $this->getCustomerLanguage();
         //  $strReqst .= "&udf13=" . $this->getCustomerMassId();
    ...
    public function atomRequest($env, $login, $password, $product, $amount, $currency, $returnUrl, $clientCode, $name, $email, $mobile, $comments, $address, $account, $requestHashKey){
        ...
        $this->setCustomerComments($comments);
        $this->setCustomerAddress($address);
        // $this->setCustomerDateTime($DateTime);
        // $this->setCustomerLanguage($language);
        //  $this->setCustomerMassId($mass_id);
